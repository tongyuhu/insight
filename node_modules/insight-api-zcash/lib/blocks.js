...
BlockController.prototype.transformBlock = function(block, info) {
  ...
  return {
    ...
    // poc 新增字段
    baseTarget:blockObj.header.baseTarget,
    deadline:blockObj.header.deadline,
    plotID:blockObj.header.plotID,
    genSign:blockObj.header.genSign
  };
};
