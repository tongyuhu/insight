...
<head>
  <base href="/" />
	...
	<title data-ng-if="!currency.testnet" >Panda</title>
	<meta name="keywords" content="panda, transactions, blocks, address, block chain, best block, mining difficulty, hash serialized">
	<meta data-ng-if="currency.testnet" name="description" content="Panda . View detailed information on all testnet panda transactions and block. {{ $root.title + $root.titleDetail }}">
	<meta data-ng-if="!currency.testnet" name="description" content="Panda . View detailed information on all panda transactions and block. {{ $root.title + $root.titleDetail }}">
