...
Address._classifyFromVersion = function(buffer) {
  var version = {};
  buffer.readInt32BE
  var prefix = buffer[0]*256*256*256*256 + buffer[1]*256*256*256 + buffer[2]*256*256 +buffer[3]*256 + buffer[4];
...
Address._transformBuffer = function(buffer, network, type) {
  ...
  info.hashBuffer = buffer.slice(5);
...
Address.prototype.toBuffer = function() {
  var version = new Buffer(5);
  // version.writeUInt16BE(this.network[this.type], 0);
  version.fill(this.network[this.type])
